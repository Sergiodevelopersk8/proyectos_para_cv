...
import styles from './SlectorMultiple.module.css'
    ...
    <>
        ...
        <div className={styles.div}>
           <ul>
                ...
                onClick={()=> seleccionar(item)}>{item.descripcion}</li>)}
        ...
        <div className={styles.botones}>
                    ...
                    {props.seleccionados.map(item => <li onClick={()=> deseleccionar(item)}  key={item.llave}>
                            {item.descripcion}
                    </li>  )}
